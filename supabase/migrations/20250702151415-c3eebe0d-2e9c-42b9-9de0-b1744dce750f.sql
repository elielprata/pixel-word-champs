...
-- 3. REMOVER CONSTRAINTS DUPLICADAS (ao invés de índices)

-- Remover constraint duplicada da tabela user_activity_days
ALTER TABLE public.user_activity_days 
DROP CONSTRAINT IF EXISTS unique_user_activity_date;

-- Remover constraint duplicada da tabela user_roles  
