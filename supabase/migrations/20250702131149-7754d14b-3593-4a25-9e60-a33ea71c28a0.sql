-- ROLLBACK COMPLETO DAS POLÍTICAS RLS PARA ESTADO ORIGINAL
...
-- 2. RECRIAR POLÍTICAS RLS ORIGINAIS SIMPLES
...
-- 5. REMOVER FUNÇÕES PERSONALIZADAS QUE PODEM CAUSAR CONFLITOS
DROP FUNCTION IF EXISTS public.is_admin();

-- 6. COMENTÁRIO DE CONFIRMAÇÃO
COMMENT ON TABLE public.profiles IS 'Rollback completo executado - políticas RLS restauradas para estado original compatível com código revertido';