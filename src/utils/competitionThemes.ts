...
const competitionThemes: Record<string, CompetitionTheme> = {
  geral: {
    ...
    emoji: '🎯',
    description: 'Desafie seu vocabulário em 3 minutos! 🧠⚡',
  ...
  animais: {
    ...
    emoji: '🦁',
    description: 'Descubra nomes de animais da floresta! 🐍🦜',
  ...
  esportes: {
    ...
    emoji: '⚽',
    description: 'Mostre seu conhecimento esportivo! 🏆⚡',
  ...
  tecnologia: {
    ...
    emoji: '💻',
    description: 'Desvende termos do mundo digital! 🤖💡',
  ...
  ciencias: {
    ...
    emoji: '🔬',
    description: 'Explore o universo científico! ⚗️🧪',
  ...
  geografia: {
    ...
    emoji: '🌍',
    description: 'Viaje pelo mundo sem sair do lugar! 🗺️✈️',
  ...
  historia: {
    ...
    emoji: '📚',
    description: 'Desvende mistérios do passado! 🏛️📜',
...
export const getCategoryDescription = (category?: string): string => {
  if (!category) return 'Desafie seu vocabulário em 3 minutos! 🧠⚡';
