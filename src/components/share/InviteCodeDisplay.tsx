...
const InviteCodeDisplay = ({ inviteCode }: InviteCodeDisplayProps) => {
  return (
    <div className="text-center bg-gradient-to-r from-purple-50 to-blue-50 p-3 rounded-xl border-2 border-dashed border-purple-200">
      <div className="flex items-center justify-center gap-2 mb-1">
        <Gift className="w-4 h-4 text-purple-600" />
        <span className="text-sm font-medium text-purple-600">Seu Código Especial</span>
      </div>
      <p className="text-xl font-bold text-gray-800 tracking-widest">{inviteCode}</p>
