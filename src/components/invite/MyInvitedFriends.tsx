        ...
        {invitedFriends.length > 0 ? (
          <div className="space-y-3">
            ...
            {invitedFriends.map((friend, index) => (
              <div key={index} className="flex items-center justify-between p-4 bg-gradient-to-r from-gray-50 to-blue-50 rounded-xl border">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2 mt-1">
                      <Badge 
                        className={`text-xs ${getFriendBadgeColor(friend)}`}
                      >
                        {friend.status}
                      </Badge>
                      {friend.level > 0 && (
                        <div className="flex items-center gap-1">
                          ...
                          <span className="text-xs text-gray-600 font-medium">Nível {friend.level}</span>
                        </div>
                      )}
                    </div>
                  </div>
