...
const CompetitionCard = ({
  ...
  if (status === 'active') {
    ...
    return <div className={`${iconConfig.colors.background} rounded-2xl p-4 shadow-lg ${iconConfig.colors.border} border relative overflow-hidden mb-3`}>
        {/* Decorações de fundo */}
        ...
        <div className="flex justify-between items-start mb-4">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              {!competitionStatus.loading && <div className="mt-1">
                  {competitionStatus.status === 'completed' && <span className="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-green-100 text-green-800">
                      ✅ Concluído
                    </span>}
          ...
          <div className="text-center">
            <div className="relative w-16 h-16">
              <svg className="w-16 h-16 transform -rotate-90" viewBox="0 0 36 36">
                ...
                <path className="text-green-400" stroke="currentColor" strokeWidth="3" strokeDasharray={`${timeRemaining.percentage * 0.96}, 96`} strokeLinecap="round" fill="none" d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831" />
              </svg>
        ...
        <CompetitionCardButton status={status} competitionId={competition.id} competitionStatus={competitionStatus} onJoin={onJoin} />
      </div>;
  }
