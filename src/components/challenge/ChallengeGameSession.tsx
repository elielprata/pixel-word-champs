    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 relative">
      <div className="absolute top-4 left-4 z-50">
        <Button 
          ...
          className="rounded-full bg-white/90 backdrop-blur-sm shadow-xl hover:bg-white hover-shadow border-2 border-white/50 transition-all duration-300 safe-interactive"
        >
