...
interface CompetitionErrorDisplayProps {
  error: string;
  onRetry: () => void;
  onBackToMenu: () => void;
}

const CompetitionErrorDisplay = ({ error, onRetry, onBackToMenu }: CompetitionErrorDisplayProps) => {
  return (
...
export default CompetitionErrorDisplay;
