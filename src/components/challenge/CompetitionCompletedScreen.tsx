...
interface CompetitionCompletedScreenProps {
  totalScore: number;
  onCompleteGame: () => void;
}

const CompetitionCompletedScreen = ({ totalScore, onCompleteGame }: CompetitionCompletedScreenProps) => {
  return (
...
export default CompetitionCompletedScreen;
