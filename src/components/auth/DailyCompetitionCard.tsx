    ...
    <div className="mb-1">
      ...
      <div className="bg-gradient-to-r from-yellow-400 to-orange-500 rounded-xl p-1.5 mb-0.5">
        <div className="flex justify-between items-center">
          <div>
            <h3 className="text-white font-bold text-sm leading-tight">Competição Semanal</h3>
          </div>
      ...
      {/* Cards de Prêmios - Altura ultra mínima */}
      <div className="flex gap-1">
        ...
        <div className="flex-1 bg-gradient-to-br from-purple-600/90 to-blue-700/90 backdrop-blur-sm rounded-xl p-1 text-center">
          ...
          <h4 className="text-white font-bold text-[9px] leading-tight mb-0">1º Lugar</h4>
        ...
        <div className="flex-1 bg-gradient-to-br from-purple-600/90 to-blue-700/90 backdrop-blur-sm rounded-xl p-1 text-center">
          ...
          <h4 className="text-white font-bold text-[9px] leading-tight mb-0">2º Lugar</h4>
          <div className="flex items-center justify-center gap-0.5">
        ...
        <div className="flex-1 bg-gradient-to-br from-purple-600/90 to-blue-700/90 backdrop-blur-sm rounded-xl p-1 text-center">
          ...
          <h4 className="text-white font-bold text-[9px] leading-tight mb-0">3º Lugar</h4>
          <div className="flex items-center justify-center gap-0.5">
