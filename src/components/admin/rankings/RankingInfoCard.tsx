...
import { Trophy, Calendar, Users, DollarSign, Settings, Eye, Download, ArrowRight, UserCog } from 'lucide-react';
...
interface RankingInfoCardProps {
  ...
  lastUpdate: string;
  // Novas props para gerenciamento de roles
  userId?: string;
  username?: string;
  currentRole?: string;
  onRoleUpdated?: () => void;
