    ...
    return <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-2">
            ...
            <Input id="startDate" type="date" value={getDateOnly(formData.startDate)} onChange={e => handleDateChange('startDate', e.target.value)} className="w-full" />
          </div>
          ...
          <div className="space-y-2">
            ...
            <Input id="startTime" type="time" value={getTimeValue()} onChange={e => handleTimeChange(e.target.value)} className="w-full" />
  ...
  return <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="space-y-2">
          ...
          <Input id="endDate" type="date" value={getDateOnly(formData.endDate)} onChange={e => handleDateChange('endDate', e.target.value)} className="w-full" />
