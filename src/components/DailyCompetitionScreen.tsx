...
import DailyChallengeGameSession from './challenge/DailyChallengeGameSession';
...
const DailyCompetitionScreen = ({ competitionId, onBack }: DailyCompetitionScreenProps) => {
  ...
  // Tela de loading
  if (isLoading) {
    return <DailyChallengeLoadingScreen />;
  }
